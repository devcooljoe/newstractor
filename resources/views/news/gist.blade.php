...
<title>Newstractor - Global Breaking news updates, Latest news headlines | Gists </title>
...
<meta property="og:url" content="{{ route('gist') }}" />
...
<div class="main-content">
	<div class="col-md-9 total-news">
		<div class="slider">
			...
			<h5 class="breaking">Gist/Gossips</h5>
			@endif
		</div>
		<div class="posts">
